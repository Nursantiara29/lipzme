...
public class AlternatifTekstur extends AppCompatActivity {
    SeekBar sb1,sb2,sb3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_alternatiftekstur);

        sb1 = (SeekBar) findViewById(R.id.SBTekstur1Alt1);
        sb2 = (SeekBar) findViewById(R.id.SBTekstur2Alt1);
        sb3 = (SeekBar) findViewById(R.id.SBTekstur3Alt1);

        tv1 = (TextView) findViewById(R.id.TxtValTekstur1);
        tv2 = (TextView) findViewById(R.id.TxtValTekstur2);
        tv3 = (TextView) findViewById(R.id.TxtValTekstur3);

        Button btnbanding = (Button) findViewById(R.id.BtnBandingkanT);

        tvlips1 = (TextView) findViewById(R.id.Lips1Tekstur1);
        tvlips2 = (TextView) findViewById(R.id.Lips2Tekstur1);
        tvlips3 = (TextView) findViewById(R.id.Lips1Tekstur2);
        tvlips4 = (TextView) findViewById(R.id.Lips3Tekstur1);
        tvlips5 = (TextView) findViewById(R.id.Lips2Tekstur2);
        tvlips6 = (TextView) findViewById(R.id.Lips3Tekstur2);
    ...
    public void onBackPressed(){
        startActivity(new Intent(this, AlternatifWarna.class));
        finish();
    }
    ...
    public void AHPAlternatif(){
         ...
         * Vektor Eigen
         */
        for(int i=0;i<vrEigTekstur.length;i++){
            vrEigTekstur[i]=jmlb[i]/tb;
        }
    }
    ...
    public void SaveVektorEigen(View view){
        ...
        edit.putString("vrEigTekstur1", String.valueOf(vrEigTekstur[0]));
        edit.putString("vrEigTekstur2", String.valueOf(vrEigTekstur[1]));
        edit.putString("vrEigTekstur3", String.valueOf(vrEigTekstur[2]));
        edit.apply();
    }
}