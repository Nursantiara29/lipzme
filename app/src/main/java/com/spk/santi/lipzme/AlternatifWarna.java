...
public class AlternatifWarna extends AppCompatActivity {
    SeekBar sb1,sb2,sb3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_alternatifwarna);

        sb1 = (SeekBar) findViewById(R.id.SBWarna1Alt1);
        sb2 = (SeekBar) findViewById(R.id.SBWarna2Alt1);
        sb3 = (SeekBar) findViewById(R.id.SBWarna3Alt1);
        sb1.setProgress(8);
        sb2.setProgress(8);
        sb3.setProgress(8);

        tv1 = (TextView) findViewById(R.id.TxtValWarna1);
        tv2 = (TextView) findViewById(R.id.TxtValWarna2);
        tv3 = (TextView) findViewById(R.id.TxtValWarna3);

        Button btnbanding = (Button) findViewById(R.id.BtnBandingkanW);

        tvlips1 = (TextView) findViewById(R.id.Lips1Warna1);
        tvlips2 = (TextView) findViewById(R.id.Lips2Warna1);
        tvlips3 = (TextView) findViewById(R.id.Lips1Warna2);
        tvlips4 = (TextView) findViewById(R.id.Lips3Warna1);
        tvlips5 = (TextView) findViewById(R.id.Lips2Warna2);
        tvlips6 = (TextView) findViewById(R.id.Lips3Warna2);
    ...
    public void onBackPressed(){
        startActivity(new Intent(this, AlternatifKualitas.class));
        finish();
    }
    ...
    public void AHPAlternatif(){
         ...
         * Vektor Eigen
         */
        for(int i=0;i<vrEigWarna.length;i++){
            vrEigWarna[i]=jmlb[i]/tb;
        }
    }
    ...
    public void AlternatifTekstur(){
        Intent intent=new Intent(this, AlternatifTekstur.class);
    ...
    public void SaveVektorEigen(View view){
        ...
        edit.putString("vrEigWarna1", String.valueOf(vrEigWarna[0]));
        edit.putString("vrEigWarna2", String.valueOf(vrEigWarna[1]));
        edit.putString("vrEigWarna3", String.valueOf(vrEigWarna[2]));
        edit.apply();
    }
}